...
- Ürün Sahibi, Ürün İş Listesi'ni yönetmekle sorumlu tek kişidir. Buradaki işler için Geliştirme Takımından destek alabilir ama sorumluluk ondadır.

* Geliştirme Takımı'nın Ürün Sahibi'nden genel olarak beklentileri:

1. Takımına zaman ayırması
2. Takımına güven duyması
3. Vizyonunu açık ve anlaşılır bir şekilde yansıtması
4. Takımına işin içine dahil olduklarını hissettirmesi
...
- Product Backlog Item'larından oluşur
- Her bir item için Bitti Tanımının (Definition of Done) ürün iş listesine eklenmesi gerekir
- Ürün İş Listesinin sorumluluğu Ürün Sahibi'ndedir
